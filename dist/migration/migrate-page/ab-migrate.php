					...
					<div class="ab-block-split-left">
						<div class="ab-titles">
							...
							<?php
								...
								echo sprintf( esc_html__( 'Same powerful blocks, same beautiful designs, same innovative team. Atomic Blocks been renamed to Genesis Blocks. %1$s', 'atomic-blocks' ), '<a target="_blank" href="https://studiopress.com/genesis-blocks/">Learn more about Genesis Blocks.</a>' );
							?>
							</p>
							<?php
