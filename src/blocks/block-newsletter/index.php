...
function atomic_blocks_render_newsletter_block( $attributes ) {
	...
	// @todo load frontend js

	$form = '
		<form method="post">
			<label for="atomic-blocks-newsletter-email-address">' . esc_html( $email_input_label ) . '</label>
			<input type="text" id="atomic-blocks-newsletter-email-address" name="atomic-blocks-newsletter-email-address" />
			<button class="' . esc_attr( $button_class ) . '" type="submit" ' . $button_styles . '>' . esc_html( $button_text ) . '</button>
