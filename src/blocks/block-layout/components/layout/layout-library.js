					...
					<Fragment>
						...
						<div className={ 'ab-layout-view' }>
							...
							<div className={ 'ab-layout-view-right' }>
								<Tooltip
									key={
										'layout-library-grid-view-tooltip-' +
										this.props.clientId
									}
								...
								>
									<Button
										key={
											'layout-library-grid-view-button-' +
											this.props.clientId
										}
										className={ classnames(
											'grid' === this.state.activeView
												? 'is-primary'
												: null,
									...
									>
										<Dashicon
											key={
												'layout-library-grid-view-dashicon-' +
												this.props.clientId
											}
											icon={ 'screenoptions' }
								...
								<Tooltip
									key={
										'layout-library-full-view-tooltip-' +
										this.props.clientId
									}
									text={ __(
										'Full Width View',
								...
								>
									<Button
										key={
											'layout-library-full-view-button-' +
											this.props.clientId
										}
										className={ classnames(
									...
									>
										<Dashicon
											key={
												'layout-library-full-view-dashicon-' +
												this.props.clientId
											}
											icon={ 'tablet' }
											className={
												'ab-layout-icon-tablet'
											}
										/>
									</Button>
								</Tooltip>
